...
void atualizarAluno(Aluno *alunos, int n_aluno);
void removerAluno(Aluno *alunos, int *qtd_alunos, int n_aluno);
void buscarMatricula(Aluno *alunos, int qtd_alunos, int matricula);
void buscarParteNome(Aluno *alunos, int qtd_alunos, char parte_nome[120]);
